# Generated by Django 2.1.3 on 2019-05-22 06:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('success_req', models.CharField(max_length=16)),
                ('lose_req', models.CharField(max_length=16)),
                ('count_req', models.CharField(max_length=16)),
                ('avg_time', models.CharField(max_length=16)),
                ('count_time', models.CharField(max_length=16)),
