...
class News(models.Model):
    ...
    summary = models.CharField(max_length=128,null=True,default="戳我，查看详细信息>>>") # 新闻主体内容
    url = models.URLField(null=True) # url
    domain = models.CharField(max_length=32,default="www.toutiao.com") # 域名
    icon = models.CharField(max_length=32,default="//s3a.pstatp.com/toutiao/resource/ntoutiao_web/static/image/favicon_5995b44.ico ") # 图标
    img_href = models.CharField(max_length=64,default="") # 图片链接
    explain = models.CharField(max_length=32,default="今日头条") # 来源注释
